		...
		<div className={`flex items-center gap-3 ${className}`}>
			...
			<div className="flex items-center gap-2">
				{platforms.map((platform) => (
					<button
						...
						onClick={() => openShareWindow(
							platform.shareUrl(url, title, description), 
							platform.name.toLowerCase()
						)}
						className={`flex items-center gap-2 p-2 rounded-lg text-neutral-600 dark:text-neutral-400 ${platform.color} transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800`}
				...
				<button
					...
					className="flex items-center gap-2 p-2 rounded-lg text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800"
