...
function handler(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, fontDataRegular, fontDataMedium, fontDataSemiBold, fontDataBold, fontDataExtraBold, searchParams, ogData, authorEncoded, isDefaultModeDark, readTime, comments, reactions, domain, encodedTitle, bgcolor, author, photo, title, bannerBackground, titleTailwindClass;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    authorEncoded = ogData.author, isDefaultModeDark = ogData.isDefaultModeDark, readTime = ogData.readTime, comments = ogData.comments, reactions = ogData.reactions, domain = ogData.domain, encodedTitle = ogData.title, bgcolor = ogData.bgcolor;
                    author = decodeURIComponent(authorEncoded);
                    photo = ogData.photo ? (0, image_1.resizeImage)(ogData.photo, {}) : const_1.DEFAULT_AVATAR;
                    title = decodeURIComponent(encodedTitle);
                    bannerBackground = isDefaultModeDark ? '#0f172a' : '#f3f4f6';
                    if (bgcolor) {
				...
				<div tw={"relative flex flex-col items-center p-10 ".concat(isDefaultModeDark ? 'bg-black' : 'bg-white', " ").concat(isDefaultModeDark ? 'text-white' : 'text-slate-900', " h-full w-full rounded-xl shadow-md")}>
					...
					<div tw="flex flex-1 flex-col items-center justify-center">
						...
						<p tw={"".concat(titleTailwindClass, " mb-5 mt-0 text-center font-extrabold leading-tight")}>
							{title}
						</p>
					</div>
					<div tw="flex w-full flex-row items-center justify-between leading-none">
						<div tw="flex flex-row items-center">
							{reactions && (<div tw="mr-10 flex flex-row items-center">
									<svg fill="#64748b" style={{
                                    height: '2rem',
                                    width: '2rem',
                                    marginRight: '0.75rem',
                                }} viewBox="0 0 512 512">
							...
							{comments && (<div tw="flex flex-row items-center">
									<svg fill="#64748b" style={{
                                    height: '2rem',
                                    width: '2rem',
                                    marginRight: '0.75rem',
						...
						{readTime && (<div tw="flex flex-row items-center">
								<svg fill="#64748b" style={{
                                    height: '2rem',
                                    width: '2rem',
                                    marginRight: '0.75rem',
