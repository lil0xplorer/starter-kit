...
function PubLoaderComponent(props) {
    var layout = props.layout;
    return (<>
      <div className={(0, tailwind_merge_1.twJoin)('mb-16', layout === 'grid' ? 'w-full px-4 lg:w-1/2 lg:px-8' : 'px-4 lg:px-16')}>
        <div className={layout === 'grid' ? 'flex flex-col-reverse' : 'flex w-full flex-row flex-wrap items-start'}>
          ...
          <div className={layout === 'grid' ? 'mb-6 w-full' : 'mt-6 w-full lg:mt-0 lg:w-2/5 lg:pl-8'}>
            <div className={(0, tailwind_merge_1.twJoin)('post-cover', 'bg-slate-200 dark:bg-slate-800', layout === 'grid' ? 'w-full rounded-lg' : 'h-40 w-full rounded-lg')}/>
          </div>
        </div>
      </div>
      <div className={(0, tailwind_merge_1.twJoin)('mb-16', layout === 'grid' ? 'w-full px-4 lg:w-1/2 lg:px-8' : 'px-4 lg:px-16')}>
...
exports.default = PubLoaderComponent;
